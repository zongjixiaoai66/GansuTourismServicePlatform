...
public class JiudianOrderView extends JiudianOrderEntity implements Serializable {
	...
	*/
	...
	private String jiudianOrderPaymentValue;
	...
	* 获取： 支付类型的值
	*/
	public String getJiudianOrderPaymentValue() {
		return jiudianOrderPaymentValue;
	}
	/**
	* 设置： 支付类型的值
	*/
	public void setJiudianOrderPaymentValue(String jiudianOrderPaymentValue) {
		this.jiudianOrderPaymentValue = jiudianOrderPaymentValue;
	}
	...
	public String toString() {
		return "JiudianOrderView{" +
			...
			", jiudianOrderPaymentValue=" + jiudianOrderPaymentValue +
