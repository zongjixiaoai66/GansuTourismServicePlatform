    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价/份" prop="meishiNewMoney">
                       <el-input v-model="ruleForm.meishiNewMoney"
                                 placeholder="现价/份" clearable  :readonly="ro.meishiNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="现价/份" prop="meishiNewMoney">
                           <el-input v-model="ruleForm.meishiNewMoney"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.meishiContent"  label="美食介绍" prop="meishiContent">
