    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单编号" prop="meishiOrderUuidNumber">
                       <el-input v-model="ruleForm.meishiOrderUuidNumber"
                                 placeholder="订单编号" clearable  :readonly="ro.meishiOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单编号" prop="meishiOrderUuidNumber">
                           <el-input v-model="ruleForm.meishiOrderUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="派送人" prop="meishiOrderCourierName">
                       <el-input v-model="ruleForm.meishiOrderCourierName"
                                 placeholder="派送人" clearable  :readonly="ro.meishiOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="派送人" prop="meishiOrderCourierName">
                           <el-input v-model="ruleForm.meishiOrderCourierName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="联系方式" prop="meishiOrderCourierNumber">
                       <el-input v-model="ruleForm.meishiOrderCourierNumber"
                                 placeholder="联系方式" clearable  :readonly="ro.meishiOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="联系方式" prop="meishiOrderCourierNumber">
                           <el-input v-model="ruleForm.meishiOrderCourierNumber"
